...
import { PluginsReferencingMCPServerSection } from '../../agent-plugins/components/PluginsReferencingMCPServerSection';
import { AgentsUsingMCPServerSection } from '../../agent-registry/components/AgentsUsingMCPServerSection';
    ...
    >
      ...
      >
        ...
        <Tabs.Content value="connect" css={{ ...flexColumnGapStyles(theme, theme.spacing.md) }}>
          ...
          {/*
            Cross-registry reverse lookups, RFC-0010's "Referenced by" and RFC-0011's blast
            radius on the MCP axis. Mounted here because this is where a server owner decides
            whether deprecating a version is safe.
          */}
          <PluginsReferencingMCPServerSection serverName={server.name} serverVersion={version.version} />
          <AgentsUsingMCPServerSection serverName={server.name} serverVersion={version.version} />
        </Tabs.Content>
